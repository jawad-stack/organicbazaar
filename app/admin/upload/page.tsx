        ...
        <h1 className="text-2xl font-bold mb-6">Admin Image Upload</h1>
          ...
          <div className="space-y-6">
            ...
            {products
              ?.filter(
                (item: any) =>
                  item.slug === productSlug && item.images.length > 0
              )
              .map((item: any) => (
                <div className="mt-2" key={item.slug}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.images.map((img: any, i: number) => (
                      <div key={i}>
                        <div className="w-24 h-24 relative bg-muted overflow-hidden rounded">
                          <Image
            ...
            <div className="mt-6 text-sm text-muted-foreground">
              <p>
                ...
                <code>ADMIN_USER</code> and <code>ADMIN_PASS</code>.
              </p>
              <p>
                Uploaded images are saved to <code>/public/uploads</code> and
                attached to the product's `images` array.
              </p>
            </div>
          </div>
      </div>
