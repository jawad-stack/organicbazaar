      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ol className="space-y-3 text-muted-foreground list-decimal list-inside">
                  <li>Contact our support team at organicbazaarofficial@gmail.com with your order number</li>
          ...
          <Card className="p-8">
            ...
            <p className="text-muted-foreground">
              Email us at organicbazaarofficial@gmail.com with your order number and what you'd like to exchange.
            </p>
          </Card>
          ...
          <Card className="p-8 bg-primary/5 border-primary/20">
            ...
            <p className="text-muted-foreground">
              Our customer service team is happy to help. Contact us at organicbazaarofficial@gmail.com or call
              1-800-ORG-GOOD.
            </p>
          </Card>
        </div>
