...
export const metadata: Metadata = {
  ...
  description: "Browse our complete selection of 100% organic, sustainably sourced products.",
    ...
    return (
      <main className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <p className="text-muted-foreground">Discover our complete selection of organic products</p>
        </div>
